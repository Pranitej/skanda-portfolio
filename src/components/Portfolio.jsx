...
export default function Portfolio() {
  ...
  const categories = [
    "All",
    ...new Set(config.portfolio.map((p) => p.category)),
  ];
  const filtered =
    activeFilter === "All"
      ? config.portfolio
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-32 right-[10%] w-96 h-96 bg-brand-200/10 dark:bg-brand-500/4 rounded-full blur-3xl animate-float-reverse"
